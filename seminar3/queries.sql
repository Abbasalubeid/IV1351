------------------------------------------------------------------------------------
--- This file contains all queries for seminar 3 ----
------------------------------------------------------------------------------------
...
-- Query 1 --> Show the number of lessons given per month during a specified year.
       ...
       -- Dummy sum function to that each month appears once in the view.
       ...
       -- coalesce is used to still calculate if the value is null on a column
       SELECT *, 
       COALESCE(ensemble, 0) + 
